...
def __init__(self, vrOverlayCenterOffset=None):
        ...
        def text():
                #bySoby
                t = bs.newNode('text',
                       attrs={ 'text':u'\ue043Hi This is new Developing server\ue043\n Will be Developed soon',
                              'scale':1.2,
                              'maxWidth':0,
                              'position':(0,138),
                              'shadow':0.5,
                ...
                #bySoby
                t = bs.newNode('text',
                       attrs={ 'text':'Admins and Commands are Added Now',
                              'scale':1.2,
                              'maxWidth':0,
                              'position':(0,138),
                              'color':((0+random.random()*1.0),(0+random.random()*1.0),(0+random.random()*1.0)),
                ...
                #bySoby
                t = bs.newNode('text',
                       attrs={ 'text':'On Creating we offer Free Commands to You \n /help     to Know the available commands ',
                              'scale':1.2,
                              'maxWidth':0,
                              'position':(0,139),
                              'shadow':0.5,
                ...
                t = bs.newNode('text',
                       attrs={ 'text':'SOME OF THE MEMBERS MISUSED COMMANDS \n SO THE COMMANDS ARE LIMITED',
                              'scale':1.2,
                              'maxWidth':0,
                              'position':(0,138),
                              'shadow':0.5,
                ...
                ##
                t = bs.newNode('text',
                       attrs={ 'text':'For Free Adminship use     /request  \n You can request the server for adminship',
                               'scale':1.2,
                              'maxWidth':0,
                              'position':(0,138),
                              'shadow':0.5,
                ...
                t = bs.newNode('text',
                       attrs={ 'text':'Coded By Mohan Raj (Python Programmer)',
                               'scale':1.2,
                              'maxWidth':0,
                              'position':(0,138),
                              'shadow':0.5,
                              ...
                              'hAlign':'center',
                              'vAttach':'bottom'})
                bs.animate(t,'opacity',{54000: 0.0,54500: 1.0,60500: 1.0,61000: 0.0})
                bs.gameTimer(51000,t.delete)
