        ...
        if isinstance(msg, bs.PickedUpMessage):
            ...
            if (msg.powerupType == 'tripleBombs'):
                ...
                alist = ['mohanRaj', 'mohan', 'Mohan', 'mohanraj', 'mohan raj',
                    'Mohan raj', 'Mohanraj', 'MohanRaj', 'Mohan Raj', 'Nippy']
            	...
            	bsUtils.PopupText("FRY", color=(0, 1.0, 1.0), scale=1.6,
            ...
            if msg.hitType == 'punch':
                ...
                if damage >= 1 and damage < 99:
                     ...
                     bsUtils.PopupText("Noob", color=((0+random.random()*1.0), (0+random.random(
                     )*1.0), (0+random.random()*1.0)), scale=1.6, position=self.node.position).autoRetain()
                     ...
                     bsUtils.PopupText("Good", color=((0+random.random()*1.0), (0+random.random(
                     )*1.0), (0+random.random()*1.0)), scale=1.6, position=self.node.position).autoRetain()
