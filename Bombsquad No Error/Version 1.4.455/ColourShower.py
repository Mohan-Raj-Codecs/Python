...
def bsGetLevels():
    return [ bs.Level('Meteor Shower', displayName='${GAME}', gameType=MeteorShowerGame,
                      settings={}, previewTexName='rampagePreview'),
             bs.Level('Meteor Shower', displayName='${GAME}', gameType=MeteorShowerGame,
...
class MeteorShowerGame(bs.TeamGameActivity):
    ...
    def getDescription(cls, sessionType):
        return 'Dodge or Throw the falling colour bombs.'
    ...
    def _dropBombCluster(self):
        ...
        for i in range(random.randrange(1,3)):
            ...
            blisty=['normal','impact','sticky','ice','landMine','tnt']
            ra=random.randint(0,5)
            bx=blisty[ra]
            bs.gameTimer(delay,bs.Call(self._dropBomb,pos,vel,bx))
            delay += 100
