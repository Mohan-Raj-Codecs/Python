...
class PowerupFactory(object):
    ...
    def __init__(self):
        ...
        self.texvirus = bs.getTexture("achievementFreeLoader")
        self.texsmario = bs.getTexture("achievementWall")
        self.texboti = bs.getTexture("achievementSharingIsCaring")
        self.texspunch = bs.getTexture("achievementSuperPunch")
        self.texbbomb = bs.getTexture("graphicsIcon")
        self.texshower = bs.getTexture("achievementOnslaught")
        self.texslm = bs.getTexture("achievementMine")
        self.texsman = bs.getTexture("agentIcon")
        self.texspeedy = bs.getTexture("powerupSpeed")
...
def getDefaultPowerupDistribution():
    return (('tripleBombs', 2),
            ...
            ('smario', 1),
            ('spunch', 2),
            ('virus', 1),  # strong powerup less will be ok
            ('curse', 2))
...
class Powerup(bs.Actor):
    ...
    def __init__(self, position=(0, 1, 0), powerupType='tripleBombs', expire=True):
        ...
        elif powerupType == 'slm':
            tex = factory.texslm
        elif powerupType == 'bbomb':
            tex = factory.texbbomb
        elif powerupType == 'shower':
            tex = factory.texshower
        elif powerupType == 'virus':
            tex = factory.texvirus
        elif powerupType == 'boti':
            tex = factory.texboti
        elif powerupType == 'smario':
            tex = factory.texsmario
        elif powerupType == 'speedy':
            tex = factory.texspeedy
        elif powerupType == 'spunch':
            tex = factory.texspunch  # s stand for speed
        elif powerupType == 'sman':
            tex = factory.texsman
        else:
