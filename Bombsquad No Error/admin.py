        ...
        for p in profiles:
            try:
                ...
                if cl_str in gph.adminHashes :
                    ...
                    break
                if cl_str in gph.owners :
                    PermissionEffect(owner = self.node,prefix = 'OWNER',prefixAnim = {0: (1,0,0), 250: (0,1,0),250*2:(0,0,1),250*3:(1,0,0)})
                    break
                if cl_str in gph.killers :
                    PermissionEffect(owner = self.node,prefix = 'KILLER #1',prefixAnim = {0: (1,0,0), 250: (0,1,0),250*2:(0,0,1),250*3:(1,0,0)})
                    break
                if cl_str in gph.killere :
                    PermissionEffect(owner = self.node,prefix = 'KILLER #2',prefixAnim = {0: (1,0,0), 250: (0,1,0),250*2:(0,0,1),250*3:(1,0,0)})
                    break
                if cl_str in gph.killerq :
                    PermissionEffect(owner = self.node,prefix = 'KILLER #3',prefixAnim = {0: (1,0,0), 250: (0,1,0),250*2:(0,0,1),250*3:(1,0,0)})
                    break
            except:
                pass
