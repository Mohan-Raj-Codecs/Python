...
def __init__(self, vrOverlayCenterOffset=None):
        ...
        def text():
                ...
                ##
                t = bs.newNode('text',
                       attrs={ 'text':'Dont Spam And Abuse\n Join Our Discord Server yet_to_be_created ',
                              'scale':1.3,
                              'maxWidth':0,
                              'position':(0,138),
                              'shadow':0.5,
                ...
                #bySoby
                t = bs.newNode('text',
                       attrs={ 'text':'Dont Ask For Admin Ship \nYou Can Buy it.',
                              'scale':1.2,
                              'maxWidth':0,
                              'position':(0,138),
                              'color':((0+random.random()*1.0),(0+random.random()*1.0),(0+random.random()*1.0)),
                ...
                t = bs.newNode('text',
                       attrs={ 'text':'This is Just a Developing Server \n Will Optimized Soon..',
                              'scale':1.2,
                              'maxWidth':0,
                              'position':(0,138),
                              'shadow':0.5,
                ...
                ##
                t = bs.newNode('text',
                       attrs={ 'text': u'Welcome to \ue047HARLEY QUINN\ue047 EPIC TEAMS',
                               'scale':1.2,
                              'maxWidth':0,
                              'position':(0,138),
                              'shadow':0.5,
