...
class MagicBox(bs.Bomb):
	def __init__(self, position=(0, 1, 0), velocity=(0, 0, 0), bombType='tnt', blastRadius=2.0, sourcePlayer=None, owner=None):
		...
		bsUtils.animate(self.node, "modelScale", {0:0, 20000:5.3, 26000:5})
...
class MagicBoxGame(bs.TeamGameActivity):
	...
	@classmethod
	def getName(cls):
		return 'YSB ATOMIC BOMB'

	@classmethod
	def getDescription(cls, sessionType):
		return 'SUBSCRIBE YSB GROUP ON YOUTUBE .'
	...
	def getInstanceDescription(self):
		return ('SUBSCRIBE YSB GROUP ON YOUTUBE', self.settings['Hold Time'])
