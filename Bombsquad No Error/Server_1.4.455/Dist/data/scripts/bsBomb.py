...
class BombFactory(object):
    ...
    def __init__(self):
        ...
        self.bombModel = bs.getModel('neoSpazHead')
        self.stickyBombModel = bs.getModel('melHead')
        self.impactBombModel = bs.getModel('frostyHead')
...
class Blast(bs.Actor):
	...
	explosion.color = (random.random(),random.random(),random.random())
        ...
        light = bs.newNode('light',
                           attrs={'position':position,
                                  'color': (random.random(),random.random(),random.random()) if self.blastType == 'ice' else (random.random(),random.random(),random.random()),
  ...
  # make a scorch that fades over time
        ...
        if self.blastType == 'turret':
            bs.gameTimer(130,scorch.delete)
