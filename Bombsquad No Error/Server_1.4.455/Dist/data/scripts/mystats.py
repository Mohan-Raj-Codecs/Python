...
def refreshStats():
        ...
        f=open(htmlfile, 'w')       
	f.write('<html lang="en" ><head><meta charset="UTF-8"><title>YSB GROUP |TEAMS| - STATS</title><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/materialize/0.97.0/css/materialize.min.css"><link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons"><link rel="stylesheet" href="https://codesrc.ysbgroup.ml/bs.ysbgroup.cf%3fsite=ysbsource/stats/style.css"></head><body><div class="row"><div id="admin" class="col s12"><div class="card material-table"><div class="table-header"><span class="table-title">YSB GROUP |TEAMS|</span><div class="actions"><a href="#add_users" class="modal-trigger waves-effect btn-flat nopadding"><i class="material-icons">person_add</i></a><a href="#" class="search-toggle waves-effect btn-flat nopadding"><i class="material-icons">search</i></a></div></div><table id="datatable"><thead><tr><th>Name</th><th>Score</th><th>Kill</th><th>Deaths</th></tr></thead>')
        json_data = {}
	...
	toppersIDs=[]
		...
		toppersIDs.append(aid)
            ...
            try:
                ...
                average_score = "0"  """
	    f.write('<tbody><tr><td>'+name+'</td><td>'+scores+'</td><td>'+kills+'</td><td>'+deaths+'</td></tr>')
	f.write('</tbody></table></div></div></div><script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script><script src="https://cdn.datatables.net/1.10.7/js/jquery.dataTables.min.js"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/materialize/0.97.0/js/materialize.min.js"></script><script  src="https://codesrc.ysbgroup.ml/bs.ysbgroup.cf%3fsite=ysbsource/stats/script.js"></script></body></html>')
	f.close()
